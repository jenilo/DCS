	...
	<div class="container bg-white p-4 rounded shadow">
		...
		<div class="row g-0 p-3 border rounded bg-gray-100">
			...
			<div class="col text-end">
				...
				<button type="button" class="col btn btn-primary bg-aquablue rounded-pill" data-bs-toggle="modal" data-bs-target="#saveFileModal"><i class="fas fa-plus"></i>&nbsp Añadir registro médico</button>
			</div>
				...
				<div class="row row-cols-2 row-cols-lg-6 row-cols-md-8 row-cols-sm-4 no-gutters p-2">
					...
					@foreach($patient->medical_records->files as $file)
							<a class="text-decoration-none">
								...
								@else
									<img class="mx-auto" src="{{Storage::url($file->filePath)}}" style="width: 120px;" alt="">
								@endif
