	...
	<div class="container bg-white p-4 rounded shadow">
		...
		<div class="row g-0 p-3 border rounded bg-gray-100">
			...
			<div class="col text-end">
				<button type="button" class="btn btn-primary bg-aquablue rounded-pill mr-2" data-bs-toggle="modal" data-bs-target="#completeFormModal"><i class="fas fa-plus"></i>&nbsp Llenar formulario</button>
				<button type="button" class="col btn btn-primary bg-aquablue rounded-pill" data-bs-toggle="modal" data-bs-target="#completeFormModal"><i class="fas fa-plus"></i>&nbsp Añadir registro médico</button>
			</div>
			...
			<div class="row g-0 border rounded p-3 bg-white">
				...
				<div class="row row-cols-2 row-cols-lg-6 row-cols-md-8 row-cols-sm-4 no-gutters p-2">
					{{$patient->me}}
					@foreach($patient->medical_records->files as $files)
						<a class="text-decoration-none">
							<img class="mx-auto" src="{{asset('icons/form.png')}}" style="width: 120px;" alt="">
							<h6 class="fw-bold text-muted text-center mb-0 mt-2">Name</h6>
						</a>
					@endforeach
				</div>
			</div>
